<template>
  <div class="bg-gray-50">
    <AppNav />
    <main class="mx-auto max-w-2xl px-4 py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-none">
        <h1 class="sr-only">Checkout</h1>
        <div class="flex flex-col-reverse sm:flex-row lg:flex-row lg:gap-x-12 xl:gap-x-16">
          <!-- Checkout form -->
          <CheckoutForm class="lg:w-1/2" />
           <!-- Order summary -->
                  ...
                  <div class="ml-6 flex flex-1 flex-col">
                    <div class="flex">
                      <div class="min-w-0 flex-1">
                        <h4 class="text-sm">
                          <NuxtLink :to="product.href" class="font-medium text-gray-700 hover:text-gray-800">
                            {{ product.title }}
                          </NuxtLink>
                        </h4>
                    ...
                    <div class="flex flex-1 items-end justify-between pt-2">
                      ...
                      <div class="ml-4">
                        ...
                        <select id="quantity" name="quantity" class="rounded-md border border-gray-300 text-left text-base font-medium text-gray-700 shadow-sm focus:border-yellow-500 focus:outline-none focus:ring-1 focus:ring-yellow-500 sm:text-sm">
